        ...
        <main v-else class="page-list">
            ...
            <div class="meta-container">
                <div class="meta">
                    ...
                    <br><br>
                    <p><button class="btn-no-cover" @click="selected = 68">spin move</button> has been placed at <b>#68</b>, above Descend and below Dude Careful Its Hot.<br><br>This change pushes <b>xStep Remake</b> into the Legacy list.</p>
                    </div>
                    <div class="dark-bg">
                    <h2>Guidelines</h2>
                    <br>

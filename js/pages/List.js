        ...
        <main v-else class="page-list">
            ...
            <div class="meta-container">
                <div class="meta">
                    ...
                    <br><br>
                    <p><button class="btn-no-cover" @click="selected = 113">spin move</button> has been placed at <b>#68</b>, above Descend and below Dude Careful Its Hot.<br><br>This change pushes <b>xStep Remake</b> into the Legacy list.</p>
                    </div>
                    <div class="dark-bg">
                    <h2>Guidelines</h2>
                    <br>
                    ...
                    <div class="og" class="dark-bg">b>
                        <p>All credit goes to <b><a href="https://tsl.pages.dev/#/" target="_blank">TSL</a></b>, whose website this is a replica of. We obtained permission from its owners and have no connection to TSL. Original List by <b><a href="https://me.redlimerl.com/" target="_blank">RedLime.</b></a></</p>   
                    </div>                     
